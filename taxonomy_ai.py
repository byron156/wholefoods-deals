...
def product_fingerprint(product, taxonomy_version):
    payload = {
        ...
        "retailer_product_type": product.get("retailer_product_type"),
        "retailer_department": product.get("retailer_department"),
        "retailer_description": product.get("retailer_description"),
